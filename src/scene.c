...
Scene scene_make(){
	...
	scene_add_light_source(&scene, light_source_make_point(color_make_from_rgb(255, 255, 255), vector_make(0, 100, 0)));


	scene_add_light_source(&scene, light_source_make_global(color_make_from_rgb(10, 10, 10)));
